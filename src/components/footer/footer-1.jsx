...
export default function Footer1() {
  return (
    <>
      <Box sx={{ background: '#3b67d9', color: '#fff !important' }} py={4}>
        <Typography component="div" sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <svg stroke="currentColor" fill="#fff" xmlns="http://www.w3.org/2000/svg" height="40px" width="40px" viewBox="0 0 96 96" aria-hidden="true" focusable="false">
        ...
        <Box component={Container} color="white" overflow="hidden" pt={0}>
          <Grid container spacing={3}>
            ...
            <Grid item lg={2} md={6} sm={6} xs={6} my={{
              ...
              <Link href="/gift-card-category" rel="noopener"
                style={{
                  display: 'block',
                  color: '#AEB4BE',
                  textDecoration: 'none',
              ...
              >Gift Card</Link>
              <Link href="/blog" rel="noopener" style={{ display: 'block', color: '#AEB4BE', textDecoration: 'none', padding: '0.3rem 0rem', '&:hover': { color: '#fff', } }} >Agukart Blog</Link>
              <Link href="/top-brands" rel="noopener" style={{ display: 'block', color: '#AEB4BE', textDecoration: 'none', padding: '0.3rem 0rem', '&:hover': { color: '#fff', } }} >Our Top Brands</Link>
              <Link href="/top-stores" rel="noopener" style={{ display: 'block', color: '#AEB4BE', textDecoration: 'none', padding: '0.3rem 0rem', '&:hover': { color: '#fff', } }} >Our Top Stores</Link>
            ...
            <Grid item lg={3} md={6} sm={6} xs={6} my={{
              sm: 0,
              md: 4,
            }}>
              {
