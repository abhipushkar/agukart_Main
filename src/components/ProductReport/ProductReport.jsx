    ...
    copyrightProperties: Yup.array().of(
      Yup.object().shape({
        ...
        registeredAt: Yup.string().when("registered", {
          is: (val) => val === "Yes",
          then: () => Yup.string().required("Location of registration is required"),
          otherwise: () => Yup.string().notRequired(),
        }),
...
const ProductReport = ({ id }) => {
  ...
  const handleSubmit = async (values, resetForm) => {
    ...
    try {
      ...
      }else if(values?.ipType == "Trademark" || values?.ipType == "Counterfeit  "){
        ...
        {({ values, setFieldValue, errors, touched }) => {
            React.useEffect(() => {
              if (values.ipType === "Copyright") {
                ...
                setFieldValue("copyrightProperties", [{ title: "", type: "", example: "", registered: "", registeredAt: "", registrationNumber: "" }]);
              } else if (values.ipType === "Trademark" || values.ipType === "Counterfeit goods") {
                setFieldValue("copyrightProperties", []);
                setFieldValue("patentProperties", []);
                setFieldValue("otherProperties", []);
                setFieldValue("trademarkProperties", [{ trademark: "", registered: "" }]);
              } else if (values.ipType === "Patent") {
                setFieldValue("copyrightProperties", []);
                setFieldValue("trademarkProperties", []);
                setFieldValue("otherProperties", []);
                setFieldValue("patentProperties", [{ title: "", registered: "" }]);
              } else if (values.ipType === "Other") {
                setFieldValue("copyrightProperties", []);
                setFieldValue("trademarkProperties", []);
                setFieldValue("patentProperties", []);
                setFieldValue("otherProperties", [{ infringement: "", legalBasis: "" }]);
              } else {
                setFieldValue("copyrightProperties", []);
                setFieldValue("trademarkProperties", []);
                setFieldValue("patentProperties", []);
            ...
            <Form>
              ...
              {activeStep === 2 && (
                <Box display="grid" gap={2}>
                  ...
                  >
                    {["Copyright", "Trademark","Counterfeit goods","Patent", "Other"].map(
                      (opt) => (
                        ...
                        <>
                          {values.copyrightProperties.map((_, index) => (
                            ...
                            >
                              ...
                              {values.copyrightProperties[index].registered === "Yes" && (
                                <>
                                  <Field
                                    ...
                                    margin="normal"
                                    error={
                                      touched?.copyrightProperties?.[index]?.registeredAt &&
                                      !!errors?.copyrightProperties?.[index]?.registeredAt
                                    }
                                    helperText={
                                      <ErrorMessage
                                        name={`copyrightProperties[${index}].registeredAt`}
                                  ...
                                  <Field
                                    ...
                                    margin="normal"
                                    error={
                                      touched?.copyrightProperties?.[index]?.registrationNumber &&
                                      !!errors?.copyrightProperties?.[index]?.registrationNumber
                                    }
                                    helperText={
                                      <ErrorMessage
                                        name={`copyrightProperties[${index}].registrationNumber`}
                  ...
                  {(values?.ipType === "Trademark" || values?.ipType === "Counterfeit goods") && (
